...
import 'package:hemo_cell/admin/detailsOfDonations/regularDonation/rejectedRegularDonation%20copy/sepecific_event_screen.dart';
import 'package:hemo_cell/shared/components/components.dart';

class RejectedRegularDonation extends StatelessWidget {
  const RejectedRegularDonation({super.key});
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) =>
                                              SpecificRegularDetailScreenForRejected(
