...
class completeRegularDonation extends StatelessWidget {
  const completeRegularDonation({super.key});
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) =>
                                              SpecificCompleteRegularDonationScreen(
