      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Text('The event has been added successfully',textAlign: TextAlign.center,style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 24,color:mainColor),)),
